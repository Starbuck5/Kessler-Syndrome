...
a = Analysis(['main.py'],
             pathex=['C:/Users/Starbuck/Desktop/KesslerGit/Kessler-Syndrome'],
             binaries=[],
             datas=[],
             hiddenimports=[],
             hookspath=[],
...
exe = EXE(pyz,
          ...
          runtime_tmpdir=None,
          console=False,
          icon='C:/Users/Starbuck/desktop/icon4.ico')"""

def pgxcompile():
    os.system("cd " + os.getcwd())
    file = open("main.spec", "w+")
    file.write(spec)
    file.close()
    os.system("PyInstaller main.spec \k")
